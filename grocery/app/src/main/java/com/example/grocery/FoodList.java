...
public class FoodList extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        adapter = new FoodListAdapter(this, R.layout.activity_pro_view, list,emailFromIntent,usernme);
        gridView.setAdapter(adapter);
        sqLiteHelper = new SQLiteHelper(this, "Grocery.sqlite", null, 1);

        // get all data from sqlite
        Cursor cursor = sqLiteHelper.getData("SELECT * from FOODSCARTS where catg='fruit'");
        list.clear();
